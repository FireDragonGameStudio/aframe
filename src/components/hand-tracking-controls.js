...
var HAND_GESTURE_DATA = require("../../HandGestureData_Clean.json");
const { default: THREE } = require("../lib/three.module");
...
module.exports.Component = registerComponent("hand-tracking-controls", {
    ...
    checkIfControllerPresent: function () {
        ...
        checkControllerPresentAndSetup(this, "", { hand: hand, iterateControllerProfiles: true, handTracking: true });
    },
    ...
    detectHandGesture: (function () {
        ...
        return function () {
            ...
            for (const gesture of this.handGesturesSource.HandGestures) {
                ...
                if (
                    thumbDifference <= GESTURE_THRESHOLD_MAX &&
                    thumbDifference >= GESTURE_THRESHOLD_MIN &&
                    indexDifference <= GESTURE_THRESHOLD_MAX &&
                    indexDifference >= GESTURE_THRESHOLD_MIN &&
                    middleDifference <= GESTURE_THRESHOLD_MAX &&
                    middleDifference >= GESTURE_THRESHOLD_MIN &&
                    ringDifference <= GESTURE_THRESHOLD_MAX &&
